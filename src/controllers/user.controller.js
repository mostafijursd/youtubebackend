...
const changeCurrentPassword = asyncHandler(async(req, res) => {
    ...
    const user = req.user && req.user._id ? await User.findById(req.user._id) : null;
...
const updateUserAvatar = asyncHandler(async(req, res) => {
    ...
    const avatarLocalPath = (req.file && req.file.path) ? req.file.path : undefined;
    if (!avatarLocalPath) {
...
const updateUserCoverImage = asyncHandler(async(req, res) => {
    const coverImageLocalPath = (req.file && req.file.path) ? req.file.path : undefined;
